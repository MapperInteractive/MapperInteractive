...
Currently implemented blocks can be found at `web/modules/blocks <https://github.com/MapperInteractive/MapperInteractive/web/modules/blocks>`_. These include
