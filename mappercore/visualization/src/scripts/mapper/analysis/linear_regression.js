define(function (require) {
  ...
  return Backbone.View.extend({
    ...
    initialize: function (states) {
      ...
      this.listenTo(this.graph.states, 'change:selection', () => this.onSelectionChanged());
    ...
    onSelectionChanged: function () {
      this.render();
      let selection = this.graph.states.get('selection');
    ...
    render: function () {
      ...
      this.states.get('algorithms').map((a) => {
    ...
    buildData: function () {
      let transform = this.states.get('transform');
      let selection = this.graph.states.get('selection');
    ...
    drawFig: function (fig, responseData, title) {
      let scaleMargin = {top: 40, left: 10, right: 10, bottom: 20},
        ...
        data = _.zip(this.states.get('attributes'), responseData).map((f) => {
