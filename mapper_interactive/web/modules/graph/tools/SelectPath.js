  ...
  return function (_GraphMode) {
    ...
    _createClass(SelectPathMode, [{
      ...
      value: function markInitialCandidates() {
        ...
        this.graph.getNodes().filter(function (d) {
      ...
      value: function setCandidates(nodeIdList) {
        ...
        this.graph.getLinks().filter(function (d) {
      ...
      value: function preparing() {
        ...
        this.nodes = _.object(this.graph.getNodes().data().map(function (n) {
          return [n["id"], { "id": n["id"], "neighbors": [] }];
        }));

        this.graph.getLinks().data().forEach(function (link) {
      ...
      value: function findNodeById(id) {
        return this.graph.getNodes().filter(function (d) {
          return d["id"] === id;
        });
      }
    }, {
