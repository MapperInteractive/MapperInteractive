  ...
  return function (_GraphBehavior) {
    ...
    _createClass(ForceSimulation, [{
      ...
      value: function _graphDidRender() {
        ...
        var _graph$getData$attrib = this.graph.getData().attributes,
            nodes = _graph$getData$attrib.nodes,
            links = _graph$getData$attrib.links;
      ...
      value: function _ticked() {
        ...
        this.graph.getLinks().attr("x1", function (d) {
          return d.source.x;
        }).attr("y1", function (d) {
          return d.source.y;
        }).attr("x2", function (d) {
        ...
        this.graph.getNodes().attr("cx", function (d) {
          return d.x;
        }).attr("cy", function (d) {
          return d.y;
        });
