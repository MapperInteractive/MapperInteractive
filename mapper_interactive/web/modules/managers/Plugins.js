...
define(function (require) {
  ...
  return function (_AbstractManager) {
    _inherits(PluginsManager, _AbstractManager);

    function PluginsManager() {
      _classCallCheck(this, PluginsManager);

      return _possibleConstructorReturn(this, (PluginsManager.__proto__ || Object.getPrototypeOf(PluginsManager)).apply(this, arguments));
    }
